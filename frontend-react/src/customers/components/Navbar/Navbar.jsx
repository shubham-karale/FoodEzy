...
const Navbar = () => {
  ...
  return (
    <div className="px-5 z-50 py-[.8rem] bg-teal-700  lg:px-20 flex justify-between">
      <div className="flex items-center space-x-4">
        <div
          onClick={navigateToHome}
          className="lg:mr-10 cursor-pointer flex items-center space-x-4"
        >
          <li className="logo font-bold text-gray-300 text-2xl">FoodEZY</li>
        </div>
      ...
      <div className="flex items-center space-x-2 lg:space-x-10">
        ...
        <div className="flex items-center space-x-2">
          {auth.user?.fullName ? (
            ...
            >
              <Avatar
                sx={{ bgcolor: "white", color: teal.A800 }}
                className="bg-white"
              >
